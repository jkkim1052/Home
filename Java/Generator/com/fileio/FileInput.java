...
import com.fileio.Model;
import com.fileio.CSVParser;
...
public class FileInput {
    ...
    private HashMap<String, ArrayList<Model>> map = new HashMap<>();
    ...
    public Boolean ReadFile(String path) {
        // System.out.println("===== FileInput.ReadFile : " + path);
        Boolean state = true;
        // buffer = new BufferReader(new FileReader(path));
        try {
